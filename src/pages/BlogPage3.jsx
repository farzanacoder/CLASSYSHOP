      ...
      <Container>
        <Flex className='gap-5'>
            <Flex className='flex-col w-[70%] items-start gap-5'>
              <Image className='rounded-md' src={Blgimg2}/>
              <h1 className='text-3xl text-gray-700 font-semibold'>sustainable living through cutting-edge prefabricated homes</h1>
              <p className='text-gray-700 text-sm'>Give2 lady of  they such they sure it. Me contained explained my education. Vulgar as hearts by garret. Perceived determine departure explained no forfeited he something an. Contrasted dissimilar get joy you instrument out reasonably. Again keeps at no meant stuff. To perpetual do existence northward as difficult preserved daughters. Continued at up to zealously necessary breakfast. Surrounded sir motionless she end literature. Gay direction neglected but supported yet 
